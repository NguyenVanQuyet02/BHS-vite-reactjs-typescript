...
const SectionServices = () => {
  return (
    <div tw="relative">
      <div tw="w-full h-[893px] shrink-0 absolute z-[-10] left-0 top-[-4.3%] bg-top bg-no-repeat bg-cover bg-[url('public/assets/imgs/service/bg_service.png')]" />
      <Container tw=" mt-[126px] md:mb-10 sm:mb-4">
        ...
        <div tw="max-w-[1140px] grid gap-x-[84px] gap-y-[68px] lg:px-[18px] justify-between">
          <img
            ...
            src="public/assets/imgs/service/img_1_1_service.jpg"
            alt="img service"
          />
          <img
            tw="rounded-[25px] h-[254px] w-full lg:min-w-[725px] object-cover block col-start-2 col-end-4"
            src="public/assets/imgs/service/img_1_2_service.jpg"
            alt="img service"
          />
          <img
            tw="rounded-[25px] h-[254px] w-full lg:min-w-[725px] object-cover block col-start-1 col-end-3"
            src="public/assets/imgs/service/img_2_1_service.jpg"
            alt="img service"
          />
          <img
            tw="rounded-[25px] h-[254px] w-full max-w-[291px] object-cover block"
            src="public/assets/imgs/service/img_2_2_service.jpg"
            alt="img service"
          />
        </div>
      </Container>
