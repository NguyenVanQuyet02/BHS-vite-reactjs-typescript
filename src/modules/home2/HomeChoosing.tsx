...
const HomeChoosing = () => {
  return (
    <div tw="relative">
      <div tw="w-[524px] sm:w-full h-[350.34px] shrink-0 absolute z-[-10] left-0 bottom-[450px] sm:bottom-[120px] bg-no-repeat bg-cover bg-[url('public/assets/imgs/home2/wave_line.png')]" />
      <div tw="max-w-full w-full h-[699.34px] sm:h-[320px] shrink-0 absolute top-[-272px] md:top-[-156px] sm:top-[-42px] left-0 z-[-10] bg-cover bg-no-repeat bg-[url('public/assets/imgs/home2/Background-wcu.png')]" />
          ...
          <section tw="flex flex-wrap max-w-[500px] gap-x-[63px] mt-[5px] ml-[-2px] md:gap-x-10  md:ml-10 md:flex-col md:mt-0 sm:flex-row sm:flex-wrap sm:justify-center sm:gap-x-0 sm:mt-0 sm:ml-0">
            <div css={[stylesStatistical_wrap]}>
              <img
                ...
                src="public/assets/icons/Home2/handshake1.png"
                alt="handshake icon"
              />
            ...
            <div css={[stylesStatistical_wrap]}>
              <img
                css={[stylesStatistical_img]}
                src="public/assets/icons/Home2/brotherhood1.png"
            ...
            <div css={[stylesStatistical_wrap]}>
              <img
                css={[stylesStatistical_img]}
                src="public/assets/icons/Home2/earth1.png"
                alt="earth icon"
              />
              <div className="statistical-item-text">
            ...
            <div css={[stylesStatistical_wrap]}>
              <img
                css={[stylesStatistical_img]}
                src="public/assets/icons/Home2/doctor1.png"
                alt="doctor icon"
              />
              <div className="statistical-item-text">
